...
public class UsuarioServiceRefactored {
    ...
    public void salvar(Usuario usuario) {
        try {
            ...
            // Validação do usuário - converter para model.Usuario
            com.br.hermescomercial.model.Usuario usuarioModel = converterParaModelUsuario(usuario);
            Validator.validarUsuario(usuarioModel);
            
            // Verificar se usuário já existe (mesmo nome)
            if (usuario.getNome() != null && !usuario.getNome().trim().isEmpty()) {
            // Buscar usuários existentes
            List<com.br.hermescomercial.model.Usuario> existentesModel = usuarioRepository.buscarPorNome(usuario.getNome());
            List<Usuario> existentes = converterParaERPUsuarios(existentesModel);
            ...
            // Converter para model.Usuario antes de salvar
    ...
    public void remover(String nome) {
        try {
            ...
            // Buscar usuários existentes
            List<com.br.hermescomercial.model.Usuario> existentesModel = usuarioRepository.buscarPorNome(nome);
            List<Usuario> existentes = converterParaERPUsuarios(existentesModel);
    ...
    public List<Usuario> listar() {
        try {
            ...
            List<com.br.hermescomercial.model.Usuario> usuariosModel = usuarioRepository.listar();
            List<Usuario> usuarios = converterParaERPUsuarios(usuariosModel);
    ...
    public Usuario buscarPorNome(String nome) {
        try {
            ...
            List<com.br.hermescomercial.model.Usuario> usuariosModel = usuarioRepository.buscarPorNome(nome);
            List<Usuario> usuarios = converterParaERPUsuarios(usuariosModel);
            if (!usuarios.isEmpty()) {
    ...
    public List<Usuario> buscarPorCpfCnpj(String textoBusca) {
        try {
            ...
            List<com.br.hermescomercial.model.Usuario> usuariosModel = usuarioRepository.buscarPorCpfCnpj(textoBusca);
            List<Usuario> usuarios = converterParaERPUsuarios(usuariosModel);
    ...
    public List<Usuario> buscarClientesPorNome(String nome) {
        try {
            ...
            List<com.br.hermescomercial.model.Usuario> clientesModel = usuarioRepository.buscarClientePorNome(nome);
            List<Usuario> clientes = converterParaERPUsuarios(clientesModel);
    ...
    public List<Usuario> buscarClientesPorCpfCnpj(String textoBusca) {
        try {
            ...
            List<com.br.hermescomercial.model.Usuario> clientesModel = usuarioRepository.buscarClientePorCpfCnpj(textoBusca);
            List<Usuario> clientes = converterParaERPUsuarios(clientesModel);
    ...
    public List<Usuario> buscarClientesPorNomeCpfCnpj(String textoBusca) {
        try {
            ...
            List<com.br.hermescomercial.model.Usuario> clientesModel = usuarioRepository.buscarClientePorNomeCpfCnpj(textoBusca);
            List<Usuario> clientes = converterParaERPUsuarios(clientesModel);
    ...
    private com.br.hermescomercial.model.Usuario converterParaModelUsuario(Usuario erpUsuario) {
        ...
        // Copiar outros campos existentes
    ...
    /**
     * Converte List<model.Usuario> para List<erp.Usuario>
     */
    private List<Usuario> converterParaERPUsuarios(List<com.br.hermescomercial.model.Usuario> modelUsuarios) {
        if (modelUsuarios == null || modelUsuarios.isEmpty()) {
            return new java.util.ArrayList<>();
        }
        
        List<Usuario> erpUsuarios = new java.util.ArrayList<>();
        for (com.br.hermescomercial.model.Usuario modelUsuario : modelUsuarios) {
            Usuario erpUsuario = converterParaERPUsuario(modelUsuario);
            if (erpUsuario != null) {
                erpUsuarios.add(erpUsuario);
            }
        }
