...
public class ERPProdutoSwingController {
    ...
    private void salvarProduto() {
        ...
        try {
            ...
            if (editMode) {
                ...
                Object[] novaLinha = {
                    novoId, txtCodigo.getText(), nome, categoria, preco, estoque, 
    ...
    private void carregarDadosExemplo() {
        ...
        // Dados de exemplo
        Object[][] dados = {
            {1L, "001", "Notebook Dell Inspiron", "Informática", new BigDecimal("3500.00"), 15, "UN", "Ativo"},
            {2L, "002", "Mouse Wireless Logitech", "Informática", new BigDecimal("89.90"), 45, "UN", "Ativo"},
            {3L, "003", "Cadeira Executiva", "Escritório", new BigDecimal("450.00"), 8, "UN", "Ativo"},
            {4L, "004", "Impressora HP LaserJet", "Informática", new BigDecimal("1200.00"), 5, "UN", "Ativo"},
            {5L, "005", "Mesa de Escritório", "Escritório", new BigDecimal("320.00"), 12, "UN", "Ativo"}
        };
