...
import com.br.hermescomercial.dao.NotificacaoDAO;
...
public class NotificacaoService {
     ...
     */
    public Notificacao enviarNotificacao(String titulo, String mensagem, 
                                        Notificacao.TipoNotificacao tipo, 
                                        String usuarioDestino) {
        return enviarNotificacao(titulo, mensagem, tipo, usuarioDestino, 
     ...
     */
    public Notificacao enviarNotificacaoBroadcast(String titulo, String mensagem, 
                                                 Notificacao.TipoNotificacao tipo) {
        return enviarNotificacao(titulo, mensagem, tipo, null, 
                                Notificacao.PrioridadeNotificacao.MEDIA);
    }
     ...
     */
    public List<Notificacao> listarNotificacoesNaoLidas(String usuario) {
        try {
     ...
     */
    public void criarNotificacaoAutomatica(Notificacao.TipoNotificacao tipo, String mensagem) {
        ...
        enviarNotificacaoBroadcast(titulo, mensagem, tipo);
    }
    ...
    public void notificarEstoqueBaixo(String produto, int quantidadeAtual, int quantidadeMinima) {
        ...
        criarNotificacaoAutomatica(Notificacao.TipoNotificacao.ESTOQUE, mensagem);
    }
    ...
    public void notificarVendaRealizada(String cliente, double valor) {
        ...
        criarNotificacaoAutomatica(Notificacao.TipoNotificacao.VENDA, mensagem);
    }
