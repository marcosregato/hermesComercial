...
/**
 * Menu Lateral com Submenus em Cascade - Versão com Tabelas e Busca
 * Telas com tabelas de dados e campos de busca para cada módulo
 */
public class PDVMenuLateralTabelas {
    ...
    public PDVMenuLateralTabelas(String usuario, String nome, JPanel workArea) {
        this.usuarioAtual = usuario;
        this.nomeUsuario = nome;
        this.workArea = workArea;
        SystemLogger.ui("Criando menu lateral com tabelas para usuário: " + usuario);
    }
    ...
    public JPanel createMenuPanel() {
        try {
            ...
            SystemLogger.ui("Menu lateral com tabelas criado com 8 menus principais");
            return menuPanel;
            
        } catch (Exception e) {
            SystemLogger.error("Erro ao criar menu lateral com tabelas", e);
    ...
    private JButton createSubMenuButton(String text, String module) {
        try {
            ...
            // Ação do submenu - ABRIR TELA COM TABELAS
            button.addActionListener(e -> {
                try {
                    SystemLogger.operation("SUBMENU_CLICK", module, 
                        "Usuário: " + usuarioAtual + " acessou: " + text);
                    
                    // Abrir tela com tabelas e busca
                    abrirTelaComTabelas(text, module);
    ...
    /**
     * Abre a tela com tabelas e campos de busca
     */
    private void abrirTelaComTabelas(String item, String module) {
        try {
            SystemLogger.ui("Abrindo tela com tabelas: " + item);
            ...
            // Criar conteúdo com tabelas
            JPanel conteudoTela = criarTelaComTabelas(item, module);
            ...
            // Log de sucesso
            SystemLogger.ui("Tela com tabelas " + item + " aberta na área de trabalho principal para usuário: " + usuarioAtual);
            
        } catch (Exception e) {
            SystemLogger.error("Erro ao abrir tela com tabelas: " + item, e);
    ...
    /**
     * Cria a tela com tabelas e campos de busca
     */
    private JPanel criarTelaComTabelas(String item, String module) {
        ...
        // Conteúdo com tabela e busca
        JPanel conteudo = criarConteudoComTabela(item, module);
    ...
    /**
     * Cria o conteúdo com tabela e campos de busca
     */
    private JPanel criarConteudoComTabela(String item, String module) {
        ...
        conteudo.add(buscaPanel, BorderLayout.NORTH);
        
        // Tabela de dados
        JPanel tabelaPanel = criarPainelTabela(item, module);
        conteudo.add(tabelaPanel, BorderLayout.CENTER);
        
        // Painel de botões
        JPanel botoesPanel = criarPainelBotoesTabela(item);
    ...
    private JPanel criarPainelBusca(String item, String module) {
        ...
        buscaPanel.setPreferredSize(new Dimension(0, 80));
    ...
    private JPanel criarCamposBusca(String item, String module) {
        ...
        switch (module) {
            case "PDV":
                return criarCamposBuscaPDV(item, gbc);
            case "VENDAS":
                return criarCamposBuscaVendas(item, gbc);
            case "PRODUTOS":
                return criarCamposBuscaProdutos(item, gbc);
            case "CLIENTES":
                return criarCamposBuscaClientes(item, gbc);
            case "ESTOQUE":
                return criarCamposBuscaEstoque(item, gbc);
            case "FINANCEIRO":
                return criarCamposBuscaFinanceiro(item, gbc);
            case "RELATORIOS":
                return criarCamposBuscaRelatorios(item, gbc);
            case "CONFIGURACOES":
                return criarCamposBuscaConfiguracoes(item, gbc);
            default:
     ...
     */
    private JPanel criarCamposBuscaPDV(String item, GridBagConstraints gbc) {
     ...
     */
    private JPanel criarCamposBuscaVendas(String item, GridBagConstraints gbc) {
        JPanel panel = new JPanel(new GridBagLayout());
        panel.setBackground(Color.WHITE);
     ...
     */
    private JPanel criarCamposBuscaProdutos(String item, GridBagConstraints gbc) {
        JPanel panel = new JPanel(new GridBagLayout());
        panel.setBackground(Color.WHITE);
     ...
     */
    private JPanel criarCamposBuscaClientes(String item, GridBagConstraints gbc) {
        JPanel panel = new JPanel(new GridBagLayout());
        panel.setBackground(Color.WHITE);
     ...
     */
    private JPanel criarCamposBuscaEstoque(String item, GridBagConstraints gbc) {
        JPanel panel = new JPanel(new GridBagLayout());
        panel.setBackground(Color.WHITE);
     ...
     */
    private JPanel criarCamposBuscaFinanceiro(String item, GridBagConstraints gbc) {
        JPanel panel = new JPanel(new GridBagLayout());
        panel.setBackground(Color.WHITE);
     ...
     */
    private JPanel criarCamposBuscaRelatorios(String item, GridBagConstraints gbc) {
        JPanel panel = new JPanel(new GridBagLayout());
        panel.setBackground(Color.WHITE);
     ...
     */
    private JPanel criarCamposBuscaConfiguracoes(String item, GridBagConstraints gbc) {
        JPanel panel = new JPanel(new GridBagLayout());
        panel.setBackground(Color.WHITE);
    ...
    /**
     * Cria o painel com a tabela de dados
     */
    ...
    /**
     * Cria o painel de botões da tabela
     */
    private JPanel criarPainelBotoesTabela(String item) {
    ...
    private JPanel criarStatusBarTela(String item) {
        ...
        JLabel statusLabel = new JLabel("🟢 Sistema Online | Tabela: " + item + " | Usuário: " + usuarioAtual + " | " + 
