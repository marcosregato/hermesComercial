...
/**
 * Menu Lateral com Submenus em Cascade para Hermes Comercial PDV
 * Versão 1.0 - Menu profissional com submenus organizados
 */
public class PDVMenuLateralCascade {
    
    private JPanel menuPanel;
    private String usuarioAtual;
    private String nomeUsuario;
    
    public PDVMenuLateralCascade(String usuario, String nome) {
        this.usuarioAtual = usuario;
        this.nomeUsuario = nome;
        SystemLogger.ui("Criando menu lateral cascade para usuário: " + usuario);
    }
    ...
    public JPanel createMenuPanel() {
        ...
        SystemLogger.ui("Menu lateral cascade criado com 8 menus principais");
        return menuPanel;
    }
