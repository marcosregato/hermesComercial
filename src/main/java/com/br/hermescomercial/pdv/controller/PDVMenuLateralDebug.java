...
/**
 * Menu Lateral com Submenus em Cascade - Versão Debug
 * Correção completa de exibição de títulos e subtítulos
 */
public class PDVMenuLateralDebug {
    
    private JPanel menuPanel;
    private String usuarioAtual;
    private String nomeUsuario;
    
    public PDVMenuLateralDebug(String usuario, String nome) {
        this.usuarioAtual = usuario;
        this.nomeUsuario = nome;
        SystemLogger.ui("Criando menu lateral debug para usuário: " + usuario);
    }
    ...
    public JPanel createMenuPanel() {
        try {
            ...
            SystemLogger.ui("Menu lateral debug criado com 8 menus principais");
            return menuPanel;
            
        } catch (Exception e) {
            SystemLogger.error("Erro ao criar menu lateral debug", e);
    ...
    private void createCascadeMenu(JPanel parent, String menuTitle, String[] subMenus, String module) {
        try {
            ...
            mainButton.setText(menuTitle); // FORÇAR TÍTULO
