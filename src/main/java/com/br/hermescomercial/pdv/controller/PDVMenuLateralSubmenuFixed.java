...
/**
 * Menu Lateral com Submenus em Cascade - Versão Submenu Fixed
 * Correção específica para subtítulos dos submenus
 */
public class PDVMenuLateralSubmenuFixed {
    
    private JPanel menuPanel;
    private String usuarioAtual;
    private String nomeUsuario;
    
    public PDVMenuLateralSubmenuFixed(String usuario, String nome) {
        this.usuarioAtual = usuario;
        this.nomeUsuario = nome;
        SystemLogger.ui("Criando menu lateral submenu fixed para usuário: " + usuario);
    }
    ...
    public JPanel createMenuPanel() {
        try {
            ...
            SystemLogger.ui("Menu lateral submenu fixed criado com 8 menus principais");
            return menuPanel;
            
        } catch (Exception e) {
            SystemLogger.error("Erro ao criar menu lateral submenu fixed", e);
    ...
    private void createCascadeMenu(JPanel parent, String menuTitle, String[] subMenus, String module) {
        try {
            ...
            // Botão principal do menu - GARANTIR EXIBIÇÃO DO TÍTULO
            JButton mainButton = new JButton();
            mainButton.setText(menuTitle);
            ...
            // Criar botões de submenu - CORREÇÃO ESPECÍFICA
            for (String subMenu : subMenus) {
                JButton subButton = createSubMenuButtonFixed(subMenu, module);
    ...
    private JButton createSubMenuButtonFixed(String text, String module) {
        try {
            // CRIAÇÃO ESPECÍFICA PARA SUBTÍTULOS VISÍVEIS
            JButton button = new JButton();
            button.setText(text); // FORÇAR SUBTÍTULO
            ...
            button.addMouseListener(new MouseAdapter() {
                ...
                public void mouseEntered(MouseEvent e) {
                    try {
                        ...
                        button.setText(text); // MANTER TEXTO VISÍVEL
                    } catch (Exception ex) {
            ...
            errorButton.setBackground(Color.RED);
            errorButton.setForeground(Color.WHITE);
            errorButton.setText("❌ " + text); // FORÇAR TEXTO
            return errorButton;
        }
    }
